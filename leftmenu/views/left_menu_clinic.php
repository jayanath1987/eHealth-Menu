      ...
      // $mdsPermission = MDSPermission::GetInstance();
           ...
           $menu .="<div id='left-sidebar1' style='position:fixed1;'>\n";
				$menu .="<div class='list-group'>";
				  ...
				  $menu .="<a href='".base_url()."index.php/form/create/clinic_visits/".$pid."/?CONTINUE=clinic/view/".$pid."&clinic=".(isset($clinic_id) ? $clinic_id : null)."' class='list-group-item'><span class='glyphicon glyphicon-eye-open'></span>&nbsp;Create a clinic visit</a>";
				  $menu .="<a href='".base_url()."index.php/form/create/pomr/".$pid."/?CONTINUE=clinic/view/".$pid."' class='list-group-item'><span class='glyphicon glyphicon-eye-open'></span>&nbsp;Add/edit diagnoses</a>";
				  $menu .="<a href='".base_url()."index.php/form/create/patient_exam/".$pid."/?CONTINUE=patient/view/".$pid."' class='list-group-item'><span class='glyphicon glyphicon-check'></span>&nbsp;Add Examination</a>";
				  $menu .="<a href='".base_url()."index.php/form/create/patient_alergy/".$pid."/?CONTINUE=clinic/view/".$pid."' class='list-group-item'><span class='glyphicon glyphicon-bell'></span>&nbsp;Add Allergy</a>";
				$menu .="</div>";
