				...
				$menu .="<div class='list-group'>";
				 ...
				 if (isset($admission["OutCome"])&&($admission["OutCome"])){
				  ...
				  $menu .="<a href='".base_url()."index.php/patient/view/".$pid."' class='list-group-item'><span class='glyphicon glyphicon-user'></span>&nbsp;Patient overview</a>";
					...
					// Laura ajout admid
					$menu .="<a href='".base_url()."index.php/patient/view/".$pid."/".$admid."' class='list-group-item'><span class='glyphicon glyphicon-user'></span>&nbsp;Patient overview</a>";
//Laura
					$menu .="<a href='".base_url()."index.php/form/create/admission_visit/".$admid."/".$pid."/?CONTINUE=admission/view/".$admid."' class='list-group-item'><span class='glyphicon glyphicon-eye-open'></span>&nbsp;BHT new visit</a>";
					$menu .="<a href='".base_url()."index.php/admission/view_all_remarks/".$admid."/?CONTINUE=admission/view/".$admid."' class='list-group-item'><span class='glyphicon glyphicon-eye-open'></span>&nbsp;BHT see all visits</a>";
