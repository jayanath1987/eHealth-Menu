           ...
           $menu .="<div id='left-sidebar1' style='position:fixed1;'>\n";
			$menu .="<div class='list-group'>";
			  $menu .="<a href='' class='list-group-item active'>";
				$menu .="Inbox";
			  $menu .="</a>";
			  $menu .="<a href='".site_url('chat/my_conversations/new')."' class='list-group-item'>New</a>";
			  $menu .="<a href='".site_url('chat/my_conversations/sent')."' class='list-group-item'>Sent</a>";
			$menu .="</div>";
